...
const uint8_t ov5640_default_regs[][3] = {
	    ...
	    {0x30, 0x36, 0x69}, // { 0x30, 0x36, 0x46 },  //  PLL Multiplier
		...
		{0x38, 0x03, 0x04},  // Y_ADDR_ST (младший) - отступ 4 пикселя
		{0x38, 0x04, 0x00},  // X_ADDR_END (старший)
		{0x38, 0x05, 0x9F},  // X_ADDR_END (младший) - 159
		{0x38, 0x06, 0x00},  // Y_ADDR_END (старший)
		{0x38, 0x07, 0x83},  // Y_ADDR_END (младший) - 131
		{0x38, 0x08, 0x00},  // X_OUTPUT_SIZE (старший)
		{0x38, 0x09, 0xA0},  // X_OUTPUT_SIZE (младший) - 160
		{0x38, 0x0a, 0x00},  // Y_OUTPUT_SIZE (старший)
		{0x38, 0x0b, 0x80},  // Y_OUTPUT_SIZE (младший) - 128
		{0x38, 0x0c, 0x01},  // HTS (старший)
		{0x38, 0x0d, 0x40},  // HTS (младший) - 320
		{0x38, 0x0e, 0x00},  // VTS (старший)
		{0x38, 0x0f, 0xA0},  // VTS (младший) - 160

	    {0x38, 0x10, 0x00}, // X_OFFSET
	    {0x38, 0x11, 0x10}, // X_OFFSET
	    {0x38, 0x12, 0x00}, //Y_OFFSET
	    {0x38, 0x13, 0x06}, //Y_OFFSET
	    {0x38, 0x14, 0x31},
	    {0x38, 0x15, 0x31},
...
const uint8_t ov5640_default_regs3[][3] = {
